...
<header>
    <table class="" style="width: 100%; border-bottom: 3px solid darkred">
        ...
        <tr style="">
            <td style="padding-left: -120px; font-size: 15px; text-align: center; font-family: 'Times New Roman',serif; font-weight: bold; vertical-align: center">LAPORAN TRANSAKSI PETUGAS</td>
        </tr>
    </table>
</header>
...
<main style="margin-top: 40px">
    ...
    <table class="table" style="width: 100%; padding-top: 0.5cm">
        ...
        <tr class="text-center">
            ...
            <th style="width: 40%">Petugas</th>
            <th style="width: 30%">Bus</th>
            <th style="width: 22%">Pendapatan</th>
        </tr>
        </thead>
        <tbody>
        @php($i=1)
