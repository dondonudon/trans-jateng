    ...
    <script type="text/javascript">
        function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/tiket') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/tiket/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    {title:"Awal",field:"awal"},
                    {title:"Akhir",field:"akhir"},
                    {title:"QTY",field:"qty"},
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/tiket/edit') }}/'+id;
            });
            ...
            btnDisable.click(function (e) {
                ...
                changeStatus(
                    {id: id},
                    'disable',
                    'Nonaktifkan tiket ini?',
                    'Nonaktifkan tiket',
                    'Tiket nonaktif!',
                    'Gagal menonaktifkan tiket, silahkan coba lagi!',
                    listTable
                );
            });
            ...
            btnActivate.click(function (e) {
                ...
                changeStatus(
                    ...
                    'Aktifkan tiket',
                    'tiket aktif!',
                    'Gagal mengaktifkan tiket, silahkan coba lagi!',
                    listTable
                );
            });
        });
