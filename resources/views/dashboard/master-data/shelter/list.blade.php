                                ...
                                <div class="col-sm-12 col-md-6 col-lg-2 col-xl-2">
                                    <div class="form-group">
                                        <select class="form-control" id="fKolom">
                                            <option value="nama">Nama Shelter</option>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/shelter/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/shelter/edit') }}/'+id;
            });
