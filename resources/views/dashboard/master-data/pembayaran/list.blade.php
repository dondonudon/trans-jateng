    ...
    <script type="text/javascript">
        function changeStatus(data,status,question,commit,successResponse,failedResponse,table) {
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        url: '{{ url('dashboard/master/pembayaran') }}/'+status,
                        method: 'post',
                        data: data,
        ...
        $(document).ready(function () {
            let listTable = new Tabulator("#listTable", {
                ...
                pagination: "remote",
                ajaxFiltering: true,
                ajaxURL: "{{ url('dashboard/master/pembayaran/data') }}",
                ajaxConfig: {
                    method: "POST",
                    headers: {
            ...
            btnEdit.click(function (e) {
                ...
                window.location = '{{ url('dashboard/master/pembayaran/edit') }}/'+id;
            });
            ...
            btnDisable.click(function (e) {
                ...
                changeStatus(
                    {id: id},
                    'disable',
                    'Nonaktifkan Pembayaran ini?',
                    'Nonaktifkan Pembayaran',
                    'Pembayaran nonaktif!',
                    'Gagal menonaktifkan Pembayaran, silahkan coba lagi!',
                    listTable
                );
            });
            ...
            btnActivate.click(function (e) {
                ...
                changeStatus(
                    {id: id},
                    'activate',
                    'Aktifkan Pembayaran ini?',
                    'Aktifkan Pembayaran',
                    'Pembayaran aktif!',
                    'Gagal mengaktifkan Pembayaran, silahkan coba lagi!',
                    listTable
                );
            });
        });
